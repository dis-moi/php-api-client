...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydra:member' => '\DisMoi\Client\Model\MatchingContextJsonldRead[]',
     ...
     * Sets member.
     *
     * @param \DisMoi\Client\Model\MatchingContextJsonldRead[] $member member
     *
     * @return self
     */
    ...
    public function setTotalItems($totalItems)
    {
        if (null !== $totalItems && ($totalItems < 0)) {
            throw new \InvalidArgumentException('invalid value for $totalItems when calling InlineResponse200., must be bigger than or equal to 0.');
        }
